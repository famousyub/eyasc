...
class LinkedinScraper(object):
    ...
    def search(self):
        ...
        while self.counter < self.limit:
            headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/59.0.3071.115 Safari/537.36', 'referer':'https://www.google.com/'}
